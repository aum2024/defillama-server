...
    referralUrl: "https://mnstr.xyz?ref=DARKRAIGUYARCANE",
  ...
  },
  {
    ...
    address: null,
    symbol: "-",
    url: "https://dexr.finance",
    description: "DEXR is a non-custodial DEX aggregator with native multi-DEX routing on Base, Optimism, BNB Chain, MegaETH, and HyperEVM, plus cross-chain bridging across 17 networks (16 EVM + Solana) via LI.FI. Pre-flight simulation guarantees execution before signing, and a flat 0.3% protocol fee on tokenIn flows entirely to a Gnosis Safe multisig.",
    chain: "Base",
    chains: ["Base", "Optimism", "Binance", "MegaETH", "Hyperliquid L1"],
    ...
    twitter: "DexrFinance",
    github: ["DexrFinance"],
    methodology: "Volume is tracked via SwapExecuted events emitted by the FeeAggregatorMaster contract on each supported chain (Base, Optimism, BNB Chain, MegaETH, HyperEVM). A flat 0.3% protocol fee on the input token is taken before forwarding to the adapter (Uniswap V3/V4, Aerodrome/Velodrome, Balancer V2/V3, PancakeSwap V3, HyperSwap V3, and others). 100% of fees flow to a Gnosis Safe multisig — no token holders, no buyback. Cross-chain bridge volume routed via LI.FI is not counted here (separate integrator flow).",
    dimensions: {
      aggregators: "dexr",
      fees: "dexr",
    },
